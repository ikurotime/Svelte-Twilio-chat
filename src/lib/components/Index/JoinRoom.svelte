...
<div class="h-full w-full flex flex-col">
	...
	<div class="flex gap-3">
		<input type="text" bind:value={$roomCode} class="p-3 rounded text-center" placeholder="XXXXXXXXX" />
		<StyledButton
			text="ENTER SERVER"
			onClick={() => {}}
			type="submit"
	...
	<a href="/home/addserver" class="text-white hover:text-green-500" on:click={()=>ACTIVE_PAGE.set('add')}>or - Create a server</a>
	</form>
</div>
{/if}
